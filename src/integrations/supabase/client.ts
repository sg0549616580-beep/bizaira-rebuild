...
console.log("[BizAIra] Supabase URL:", SUPABASE_URL);
console.log("[BizAIra] Supabase key exists:", !!SUPABASE_PUBLISHABLE_KEY);
...
console.log("[BizAIra] Supabase client created");